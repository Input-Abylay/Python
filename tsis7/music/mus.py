...
playlist = [
    os.path.abspath("tsis7/music/musics/Death Grips - Come Up and Get Me.mp3"),
    os.path.abspath("tsis7/music/musics/Death Grips - Lost Boys.mp3")
]
...
class Player:
    ...
    def drawPlayButton(self):
        playButton = pygame.image.load(os.path.abspath("tsis7/music/musics/playButton.png"))
        playButton = pygame.transform.scale(playButton, (100, 100))
        return playButton

    def drawForwardAndBackwardBtns(self):
        forward = pygame.image.load(os.path.abspath("tsis7/music/musics/forwardBtn.png"))
        backward = pygame.image.load(os.path.abspath("tsis7/music/musics/backward.png"))
